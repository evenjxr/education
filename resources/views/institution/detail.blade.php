...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" method="post" action="{{ URL::route('manage.institution.update') }}">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">机构名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$institution->name}}" placeholder="" name="name">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">证件照：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					<div id="fileList" class="uploader-list">
						<input type="hidden" name="certificate_url" id="thumbnail" value="{{$institution->certificate_url}}">
						@if($institution->certificate_url)
							<img src="{{$institution->certificate_url}}"  id="img" style="width: 400px;height: 225px; margin: 10px 0;">
						@else
							<img src=""  id="img">
						@endif
					</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" name="introduction" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)">{{$institution->introduction}}</textarea>
