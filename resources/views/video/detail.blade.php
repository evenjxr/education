...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="{{ URL::route('manage.video.update') }}">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$video->tag}}" placeholder="" id="" name="tag">
			</div>
		</div>
		{{--<div class="row cl">--}}
			...
			{{--<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">--}}
				{{--<select name="channel" class="select">--}}
					...
					{{--<option value="1">├三分球</option>--}}
					{{--<option value="2">├扣篮</option>--}}
					{{--<option value="3">├绝杀</option>--}}
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					<div id="fileList" class="uploader-list">
						...
						<img src="{{$video->thumbnail}}"  id="img">
					</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="description" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" name="description" nullmsg="视频不能为空！" onKeyUp="textarealength(this,200)">{{$video->description}}</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" readonly value="{{$video->url}}" placeholder="http://" id="url" name="url" style="width: 680px;">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">时常：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$video->duration}}" placeholder="20:23" id="" name="duration">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">排序值：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="99" placeholder="{{$video->sort}}" id="" name="sort">
			</div>
		</div>
		<div class="row cl">
...
$(function(){
	...
	if (url) {
		$('#img').css({width:'160px',height:'120px'});
	}
